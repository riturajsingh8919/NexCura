import {
  Lightbulb,
  LightbulbIcon,
  LightbulbIconIconLightbulbIcon,
} from "lucide-react";
import Image from "next/image";
import React from "react";

function ContinuousInnovations() {
  return (
        ...
        <div className="bg-white py-16 px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Stay ahead with GenAI Healthcare’s cutting-edge AI solutions,
              constantly evolving to meet the future of healthcare. Our team
              blends medical expertise with technological breakthroughs to keep
              you one step ahead in your health journey.
            </p>
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-gray-900 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-gray-700 leading-relaxed">
                  Collaboration with top healthcare experts
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-gray-900 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-gray-700 leading-relaxed">
                  Integration of the latest medical research
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 bg-gray-900 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-gray-700 leading-relaxed">
                  Future-ready features to adapt with your needs
                </span>
              </li>
            </ul>
          ...
          <div className="grid grid-cols-2 gap-12 xl:gap-16 items-center">
            ...
            <div className="pl-8">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Stay ahead with GenAI Healthcare’s cutting-edge AI solutions,
                constantly evolving to meet the future of healthcare. Our team
                blends medical expertise with technological breakthroughs to
                keep you one step ahead in your health journey.
              </p>
...
export default ContinuousInnovations;
